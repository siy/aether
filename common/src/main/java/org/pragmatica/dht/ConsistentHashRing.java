 ...
 *
 * <p>The ring maps keys to partitions (0-1023), and partitions to nodes.
...
public final class ConsistentHashRing<N extends Comparable<N>> {
     ...
     */
    public static <N extends Comparable<N>> ConsistentHashRing<N> create() {
     ...
     */
    public static <N extends Comparable<N>> ConsistentHashRing<N> create(int virtualNodesPerPhysical) {
