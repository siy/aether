...
This produces `target/example-slice-0.6.2.jar` which can be loaded by the Aether runtime.

### Loading with SliceStore

```java
var artifact = Artifact.artifact("org.pragmatica-lite.aether:example-slice:0.6.2");
