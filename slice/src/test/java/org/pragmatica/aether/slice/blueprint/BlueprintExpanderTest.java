        ...
        void expand_succeeds_withDirectDependency() {
            ...
            BlueprintExpander.expand(testBlueprint, loader)
                ...
                .onSuccess(expanded -> {
                    ...
                    assertThat(loadOrder.get(0).artifact().asString()).isEqualTo("org.example:slice-b:1.0.0");
                    assertThat(loadOrder.get(1).artifact().asString()).isEqualTo("org.example:slice-a:1.0.0");
        ...
        void expand_succeeds_withTransitiveDependencies() {
            ...
            BlueprintExpander.expand(testBlueprint, loader)
                ...
                .onSuccess(expanded -> {
                    ...
                    assertThat(loadOrder.get(0).artifact().asString()).isEqualTo("org.example:slice-c:1.0.0");
                    assertThat(loadOrder.get(1).artifact().asString()).isEqualTo("org.example:slice-b:1.0.0");
                    assertThat(loadOrder.get(2).artifact().asString()).isEqualTo("org.example:slice-a:1.0.0");
            ...
            BlueprintExpander.expand(blueprint, loader)
                ...
                .onSuccess(expanded -> {
                    ...
                    var sliceAResolved = loadOrder.stream()
                        .filter(r -> r.artifact().asString().equals("org.example:slice-a:1.0.0"))
                        .findFirst()
                        .orElseThrow();
                    var sliceBResolved = loadOrder.stream()
                        .filter(r -> r.artifact().asString().equals("org.example:slice-b:1.0.0"))
                        .findFirst()
                        .orElseThrow();
                    var sliceCResolved = loadOrder.stream()
                        .filter(r -> r.artifact().asString().equals("org.example:slice-c:1.0.0"))
                        .findFirst()
                        .orElseThrow();
